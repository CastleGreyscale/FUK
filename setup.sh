...
cat > fuk/config/defaults_loras.json.template << 'EOL'
{
  ...
  "loras": [
    ...
    {
      "_ltx2_comment": "The ltx2 entries below are the point of LTX-2's design: one 35GB base transformer plus a small LoRA per function, instead of a separate fused checkpoint for every camera move. Camera_* come from Lightricks/LTX-2-19b-LoRA-Camera-Control-* (0.3GB for the dolly moves, 2.1GB for jib and static). IC_* are the in-context LoRAs and additionally need a driving video passed as control_path: IC_Union_Control takes a depth/pose/edge video to steer structure, IC_Canny/Depth/Pose_Control take that one preprocessor's video, and IC_Detailer re-renders a low-detail video with more detail. The 'ltx2/' path prefix plus 'ltx2' in 'model' is what marks these as belonging to that model: the Model Manager lists them as optional downloads under the LTX-2 row, one tick each, and download_models.sh fetches the whole set into <defined_loras_path>/ltx2/ and symlinks them — so delete the ones you do not want before a headless run. 'repo' is the upstream HuggingFace repo; it is derived from the filename when omitted."
    },
    {"name": "Camera_Dolly_In",    "path": "ltx2/ltx-2-19b-lora-camera-control-dolly-in.safetensors",    "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Dolly-In",    "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "dolly in",    "inject_text": "Dolly-in shot: the camera smoothly moves closer to the subject."},
    {"name": "Camera_Dolly_Out",   "path": "ltx2/ltx-2-19b-lora-camera-control-dolly-out.safetensors",   "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Dolly-Out",   "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "dolly out",   "inject_text": "Dolly-out shot: the camera smoothly pulls back away from the subject."},
    {"name": "Camera_Dolly_Left",  "path": "ltx2/ltx-2-19b-lora-camera-control-dolly-left.safetensors",  "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Dolly-Left",  "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "dolly left",  "inject_text": "Dolly-left shot: the camera tracks smoothly to the left."},
    {"name": "Camera_Dolly_Right", "path": "ltx2/ltx-2-19b-lora-camera-control-dolly-right.safetensors", "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Dolly-Right", "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "dolly right", "inject_text": "Dolly-right shot: the camera tracks smoothly to the right."},
    {"name": "Camera_Jib_Up",      "path": "ltx2/ltx-2-19b-lora-camera-control-jib-up.safetensors",      "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Jib-Up",      "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "jib up",      "inject_text": "Jib-up shot: the camera cranes smoothly upward."},
    {"name": "Camera_Jib_Down",    "path": "ltx2/ltx-2-19b-lora-camera-control-jib-down.safetensors",    "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Jib-Down",    "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "jib down",    "inject_text": "Jib-down shot: the camera cranes smoothly downward."},
    {"name": "Camera_Static",      "path": "ltx2/ltx-2-19b-lora-camera-control-static.safetensors",      "repo": "Lightricks/LTX-2-19b-LoRA-Camera-Control-Static",      "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "static",      "inject_text": "Static shot: the camera is locked off and does not move."},
    {"name": "IC_Union_Control",   "path": "ltx2/ltx-2-19b-ic-lora-union-control-ref0.5.safetensors",    "repo": "Lightricks/LTX-2-19b-IC-LoRA-Union-Control",           "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "", "inject_text": ""},
    {"name": "IC_Detailer",        "path": "ltx2/ltx-2-19b-ic-lora-detailer.safetensors",                "repo": "Lightricks/LTX-2-19b-IC-LoRA-Detailer",                "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "", "inject_text": ""},
    {"name": "IC_Canny_Control",   "path": "ltx2/ltx-2-19b-ic-lora-canny-control.safetensors",           "repo": "Lightricks/LTX-2-19b-IC-LoRA-Canny-Control",           "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "", "inject_text": ""},
    {"name": "IC_Depth_Control",   "path": "ltx2/ltx-2-19b-ic-lora-depth-control.safetensors",           "repo": "Lightricks/LTX-2-19b-IC-LoRA-Depth-Control",           "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "", "inject_text": ""},
    {"name": "IC_Pose_Control",    "path": "ltx2/ltx-2-19b-ic-lora-pose-control.safetensors",            "repo": "Lightricks/LTX-2-19b-IC-LoRA-Pose-Control",            "model": ["ltx2"], "default_strength": 1.0, "trigger_word": "", "inject_text": ""}
  ]
}
EOL
